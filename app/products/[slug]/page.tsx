...
import { getCategory, getProduct, getProducts } from "@/lib/content";
    ...
    <main id="main-content" className="shell space-y-8 py-10 md:space-y-10 md:py-16">
      ...
      <section className="grid gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
        <div className="min-w-0 grid gap-4">
          <div className="glass-panel relative aspect-square overflow-hidden md:aspect-[4/4.8]">
        ...
        <div className="glass-panel min-w-0 space-y-5 p-5 md:space-y-6 md:p-8">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <span className="inline-flex w-fit rounded-full border border-champagne/30 px-4 py-2 text-sm text-ink/70">{specification}</span>
