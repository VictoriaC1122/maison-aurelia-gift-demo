...
export function SiteFooter() {
  return (
    <footer className="mt-16 border-t border-champagne/20 bg-[#17120f] text-pearl md:mt-20">
      <div className="mx-auto grid w-[min(1240px,calc(100vw-24px))] gap-8 py-10 md:w-[min(1240px,calc(100vw-48px))] md:grid-cols-[1.2fr_1fr_1fr] md:gap-10 md:py-14">
        <div className="space-y-4">
          <p className="text-xs uppercase tracking-[0.35em] text-champagne">{site.brandNameZh}</p>
          <h2 className="font-display text-[2rem] md:text-3xl">{site.brandName}</h2>
