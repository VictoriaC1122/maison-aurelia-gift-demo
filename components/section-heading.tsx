...
export function SectionHeading({
  ...
  return (
    <div className={cn("max-w-3xl space-y-4", className)}>
      ...
      <Tag className="section-heading__title font-display text-[1.85rem] leading-[1.12] tracking-[-0.018em] text-ink md:text-[2.35rem] lg:text-[2.8rem] xl:text-[3.1rem] md:tracking-normal">
        {title}
      </Tag>
